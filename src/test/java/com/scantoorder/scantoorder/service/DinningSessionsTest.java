...
class DinningSessionsTest {
    ...
    void testDinningSessionCanBeCreated() {
        String createSessionResponse = diningSessionService.createSession(seatId, tableNumber, createSessionRequest.getCustomerName(), createSessionRequest.getCustomerPhone(), createSessionRequest.getCustomerEmail());
